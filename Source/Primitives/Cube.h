...
public:
    ...
    static inline float vertices[] = {
            ...
            min.x, min.y, min.z, max.x, min.y, min.z, max.x, min.y, min.z, max.x, max.y, min.z, min.x, max.y, min.z,

            min.x, min.y, max.z, min.x, min.y, min.z, min.x, max.y, min.z, min.x, max.y, min.z, min.x, max.y, max.z,
            min.x, min.y, max.z,

            max.x, min.y, min.z, max.x, min.y, max.z, max.x, max.y, max.z, max.x, max.y, max.z, max.x, max.y, min.z,
            max.x, min.y, min.z,

            min.x, min.y, max.z, min.x, max.y, max.z, max.x, max.y, max.z, max.x, max.y, max.z, max.x, min.y, max.z,
            min.x, min.y, max.z,

            min.x, max.y, min.z, max.x, max.y, min.z, max.x, max.y, max.z, max.x, max.y, max.z, min.x, max.y, max.z,
            min.x, max.y, min.z,

            min.x, min.y, min.z, min.x, min.y, max.z, max.x, min.y, min.z, max.x, min.y, min.z, min.x, min.y, max.z,
            max.x, min.y, max.z};

    inline static GLfloat vertices2[] = {1.0, 1.0, 1.0, 0.0f, 1.0, 1.0, 1.0, 1.0, 0.0f, 0.0f, 1.0, 0.0f, 1.0, 0.0f, 1.0,
                                         0.0f, 0.0f, 1.0, 0.0f, 0.0f, 0.0f, 1.0, 0.0f, 0.0f};
    // Declares the Elements Array, where the indexs to be drawn are stored
    inline static GLuint elements[] = {3, 2, 6, 7, 4, 2, 0, 3, 1, 6, 5, 4, 1, 0};
